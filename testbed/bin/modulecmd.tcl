...
proc reportInternalBug {message} {
	...
	if {[info exists env(MODULESCONTACT)]} {
        set errcontact $env(MODULESCONTACT)
    } else {
        set errcontact $contact
    }

    puts stderr "Module ERROR: $message\nPlease contact: $errcontact"
}
...
proc module {command args} {
    ...
    avail - av {
		...
		cmdModuleAvail
            ...
            #XD(22/11/2011): do not print aliases and version on avail
	        #cmdModuleAliases
	    }
	}
    aliases - al {
